...
export const phosphorCatalogEntries = [
  ...
  ['AlertSolidIcon', 'ExclamationMarkIcon', ExclamationMarkIcon, 'regular'],
  ...
  ['ArrowNarrowUpRightIcon', 'ArrowUpRightIcon', ArrowUpRightIcon, 'regular'],
  ...
  ['CommandIcon', 'CommandIcon', CommandIcon, 'regular'],
  ...
  ['DragIcon', 'DotsSixVerticalIcon', DotsSixVerticalIcon, 'regular'],
  ...
  ['File06Icon', 'FileTextIcon', FileTextIcon, 'regular'],
  ...
  ['Lightning01Icon', 'LightningIcon', LightningIcon, 'regular'],
  ['Link01Icon', 'LinkIcon', LinkIcon, 'regular'],
  ['LinkExternal01Icon', 'ArrowSquareOutIcon', ArrowSquareOutIcon, 'regular'],
  ['Loading01Icon', 'SpinnerGapIcon', SpinnerGapIcon, 'regular'],
  ...
  ['MinusIcon', 'MinusIcon', MinusIcon, 'regular'],
  ['PaperclipIcon', 'PaperclipIcon', PaperclipIcon, 'regular'],
  ['PlusIcon', 'PlusIcon', PlusIcon, 'regular'],
  ['Rocket01Icon', 'RocketLaunchIcon', RocketLaunchIcon, 'regular'],
  ...
  ['XCloseIcon', 'XIcon', XCloseIcon, 'regular'],
  ['XIcon', 'XIcon', XIcon, 'regular'],
