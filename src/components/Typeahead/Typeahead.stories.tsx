...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Searches large option sets, selects multiple values, or accepts user-created values. Use Select for one known value; removable tags currently have keyboard-accessibility debt.',
      },
    },
  },
  tags: ['autodocs'],
