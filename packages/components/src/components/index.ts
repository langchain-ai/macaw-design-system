...
//   import { TabGroup, ... } from '@langchain/macaw-components/Tabs'
//   import { Code, CodeLite } from '@langchain/macaw-components/Code'
...
// directly from `@langchain/macaw-components/<Component>`.
...
// Import directly:
//   import { HoverCard, ... } from '@langchain/macaw-components/HoverCard'
//   import { Popover, ... } from '@langchain/macaw-components/Popover'
//   import { ContextMenu, ... } from '@langchain/macaw-components/ContextMenu'
//   import { Command, ... } from '@langchain/macaw-components/Command'
...
//   import { Pane, TopBarPaneSlot } from '@langchain/macaw-components/Pane'
